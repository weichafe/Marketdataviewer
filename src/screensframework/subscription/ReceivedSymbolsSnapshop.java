...
public class ReceivedSymbolsSnapshop {

    private MDEntryPx mdEntryPx = new MDEntryPx();
    private SymbolsController controller;

    public ReceivedSymbolsSnapshop(MarketDataSnapshotFullRefresh mktDataFull){
        ...
        try {
            ...
            for (int i = 1; i <= mktDataFull.getNoMDEntries().getValue(); i++) {
                ...
                symbolsModel.setSymbol(mktDataFull.getSymbol().getValue());
